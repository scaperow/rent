...
export class PrismaQueryBuilder {
  ...
  private buildFindQuery(
    ...
    const includes = transformJoinsToInclude(
      Array.from(new Set(parsedCrudQuery.joins)),
    );
  ...
  public parseCrudQuery(crudQuery: CrudQuery): CrudQueryFull {
    ...
    const crudQueryFull: CrudQueryFull = Object.assign(
      {},
      this.DEFAULT_CRUD_QUERY,
      crudQuery,
    );
  ...
  public buildFindOneQuery(
    ...
    findOneQuery.where = {
      ...findOneQuery.where,
      [this.crudServiceOpts.idPropertyName]: id,
    };
    return findOneQuery;
  }
