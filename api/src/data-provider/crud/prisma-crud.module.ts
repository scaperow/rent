...
export class PrismaCrudModule {
  static register(opts: PrismaCrudModuleOpts): DynamicModule {
    ...
    PrismaCrudService.prismaClient =
      PrismaCrudService.prismaClient || new opts.prismaService(); // TODO: implement support for custom providers ({provide, useValue, etc})
      ...
      providers: [
        {
          ...
          useFactory: () => PrismaCrudService.prismaClient,
        },
      ],
